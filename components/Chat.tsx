  ...
  if (isOpen) {
    return (
      <div className="h-full w-full absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] max-h-[800px] grid grid-cols-12">
        ...
        <section className="relative flex flex-col justify-between bg-slate-800 col-span-full sm:col-span-6 lg:col-span-4 !col-start-5 m-20 p-20 border border-gray-300 rounded-lg space-y-16">
